<?php
// Item Discrimination mount. Same sample data as item-difficulty.
...
$current_item    = 'item_discrimination';
$lens_key        = 'item_discrimination';
...
$shell_page_title = 'Item Discrimination · ' . $_studio['name'];
...
<div class="work-breadcrumb"><span>Inferential Analysis</span><span class="sep">/</span><strong>Item Discrimination</strong></div>
<div class="work-head">
  <h2>Item Discrimination</h2>
  <p>How well does each item separate stronger students from weaker ones? Reports both the point-biserial correlation (item score vs total score minus that item) and Kelley's D-index (proportion correct in the top 27% minus the bottom 27%). D ≥ 0.40 is excellent; D &lt; 0 is a near-certain sign of a miskeyed item.</p>
</div>
