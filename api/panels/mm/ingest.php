...
// }
//
// Pushes raw text responses (and optional numeric/group fields) into the
// project. One mm_data_sources row is created per call and the rows attach
// to it. Caller may invoke this multiple times for the same project to layer
// additional sources.
...
// Cap to keep one ingest call bounded.
if (count($rows) > 5000) {
