...
// Body shapes (one of):
//   { project_id, step: "data_kind",     value: "open_ended_only" | "survey_plus_open" | ... }
//   { project_id, step: "purpose",       value: "find_themes" | "compare_groups" | ... }
//   { project_id, step: "field_map",     map: { response_id, closed:[..], open:[..], group:[..], outcome:[..], time:[..] }, source_id }
//   { project_id, step: "design_choice", value: "A_explain_numbers" | ... }
//   { project_id, step: "complete" }     // stamp wizard_completed_at
//
// Each call returns the current project state and a `next_step` hint so the
// front end never has to guess where to send the user.
...
if ($step === 'data_kind' || $step === 'purpose') {
    // Multi-select. Accept either a 'values' array or a single 'value' string
...
// Reload project and decide the recommended next step.
...
json_out([
    'ok'        => true,
    'project'   => mm_project_out($project),
    'next_step' => $nextStep,
]);
