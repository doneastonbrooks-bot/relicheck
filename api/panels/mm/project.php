<?php
// GET    /api/mm/project.php?id=N     full state of a single MM project
...
if ($method === 'GET') {
    ...
    $project = mm_require_project($pdo, $uid, $id);

    // Counts that the studio landing summary uses.
    $counts = [
    ...
    json_out(['ok' => true, 'project' => mm_project_out($project), 'counts' => $counts]);
}
