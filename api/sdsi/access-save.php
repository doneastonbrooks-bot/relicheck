...
// }
//
// Persists the human-SETTLED access review for a survey (upsert by survey_id).
// The deterministic AccessEngine on the client produces `result`; this is the
...
$pdo->prepare(
    'INSERT INTO sdsi_access_reviews
