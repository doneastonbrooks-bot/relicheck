<?php
// GET /api/sdsi/dignity-get.php?survey_id=N
// Returns the saved (settled) Dignity / Framing review for a survey, if any.
...
$stmt = $pdo->prepare(
    'SELECT population, flags, mitigations, score, sdsi_points, band, launch_ready, blocker_count, updated_at
       FROM sdsi_dignity_reviews WHERE survey_id = :sid'
);
