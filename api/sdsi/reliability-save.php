<?php
// POST /api/sdsi/reliability-save.php
// Body: {
//   survey_id: int,
//   component: string,
...
// }
//
// Persists the human-SETTLED reliability review for a (survey, component) pair
...
foreach ($spec['contextFields'] as $cf) {
    ...
    if ($cf['type'] === 'list') {
        ...
        // item_count / min_common_items: keep numeric (warning denominators).
...
$pdo->prepare(
    'INSERT INTO sdsi_reliability_reviews
