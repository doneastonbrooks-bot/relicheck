<?php
// GET /api/sdsi/reliability-get.php?survey_id=N&component=KEY
// Returns the saved (settled) reliability review for a (survey, component) pair.
...
if (!reliability_component_spec($component)) fail('bad_component', 'Unknown reliability component.');
...
$stmt = $pdo->prepare(
    'SELECT context, flags, mitigations, score, sdsi_points, band, launch_ready, blocker_count, updated_at
       FROM sdsi_reliability_reviews WHERE survey_id = :sid AND component = :comp'
);
