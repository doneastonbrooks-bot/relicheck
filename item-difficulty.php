<?php
// Item Difficulty mount. Inline TIA sample (20 students × 8 MC items).
// Designed so q4 is very hard, q5 is deliberately miskeyed (real answer
// is B but key says A), and the rest span a normal range.
...
$current_item    = 'item_difficulty';
$lens_key        = 'item_difficulty';
...
$answer_key = [
  ...
  ['item'=>'q2','correct'=>'B','max'=>1,'type'=>'MC'],
  ['item'=>'q3','correct'=>'C','max'=>1,'type'=>'MC'],
  ['item'=>'q4','correct'=>'D','max'=>1,'type'=>'MC'],
  ['item'=>'q5','correct'=>'A','max'=>1,'type'=>'MC'],  // deliberately miskeyed: real answer is B
  ['item'=>'q6','correct'=>'B','max'=>1,'type'=>'MC'],
  ['item'=>'q7','correct'=>'A','max'=>1,'type'=>'MC'],
  ['item'=>'q8','correct'=>'C','max'=>1,'type'=>'MC'],
];
$dataset = ['source'=>'Math Grade 8 Assessment (sample)','variables'=>$variables,'rowCount'=>count($rows),'answer_key'=>$answer_key];

$shell_page_title = 'Item Difficulty · ' . $_studio['name'];
...
<div class="work-breadcrumb"><span>Inferential Analysis</span><span class="sep">/</span><strong>Item Difficulty</strong></div>
<div class="work-head">
  <h2>Item Difficulty</h2>
  <p>Per-item p-value (proportion of students who answered correctly). Banded into very easy / easy / moderate / hard / very hard. The healthy spread for a discriminating test is centered around 0.40-0.70, with a few items at the extremes for ceiling-busting and floor-checking purposes.</p>
</div>
