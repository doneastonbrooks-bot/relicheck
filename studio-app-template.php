...
:root {
  ...
  --btn:#5a6a7e; --btn-hover:#47576a;
  --acc:#5a6a7e; --acc-soft:#eef1f5; --acc-deep:#3d4f62;
...
<script src="/apps/studio/studio-app-template.js?v=<?= _tpl_qsv('/apps/studio/studio-app-template.js') ?>" defer></script>
</body>
</html>
