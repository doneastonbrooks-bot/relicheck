...
return [
  ...
  'inferential' => [
    ...
    ['id' => 'paired_t_test',   'label' => 'Paired t-Test',        'dot' => 'quan', 'mode' => 'work', 'tool' => 'paired_t_test'],
    ['id' => 'anova',            'label' => 'ANOVA',                'dot' => 'quan', 'mode' => 'work', 'tool' => 'anova'],
    ['id' => 'post_hoc',         'label' => 'Post-Hoc',             'dot' => 'quan', 'mode' => 'work', 'tool' => 'post_hoc'],
    ['id' => 'two_way_anova',    'label' => 'Two-Way ANOVA',        'dot' => 'quan', 'mode' => 'work', 'tool' => 'two_way_anova'],
    ...
    ['id' => 'logistic_regression','label' => 'Logistic Regression','dot' => 'quan', 'mode' => 'work', 'tool' => 'logistic_regression'],
