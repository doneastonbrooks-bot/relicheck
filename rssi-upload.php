    ...
    <div class="upload-stage" id="rssiUploadStage">
      ...
      <div class="upload-card">
        ...
        <div class="dropzone" id="rssiDropzone">
          <input type="file" id="rssiFileInput" accept=".csv,.tsv,.txt,.xls,.xlsx,text/csv,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" style="display:none;">
