...
$current_item    = 'distractor_analysis';
$lens_key        = 'distractor_analysis';
...
$shell_page_title = 'Distractor Analysis · ' . $_studio['name'];
...
<div class="work-breadcrumb"><span>Inferential Analysis</span><span class="sep">/</span><strong>Distractor Analysis</strong></div>
<div class="work-head">
  <h2>Distractor Analysis</h2>
  <p>For multiple-choice items, which incorrect answer options ("distractors") actually do their job? Functioning distractors draw at least some students — ideally more from the lower-scoring group than the upper. Unused distractors are dead weight; distractors that attract more top scorers than bottom scorers are likely ambiguous or genuinely defensible alternative answers.</p>
</div>
