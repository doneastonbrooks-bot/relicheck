<?php
// Differential Item Functioning mount.
...
$shell_page_title = 'Differential Item Functioning · ' . $_studio['name'];
...
<div class="work-breadcrumb"><span>Inferential Analysis</span><span class="sep">/</span><strong>Differential Item Functioning</strong></div>
<div class="work-head">
  <h2>Differential Item Functioning</h2>
  <p>For each item, compare the p-value (proportion correct) between two demographic groups. Large gaps suggest the item may be biased — easier for one group than another for reasons unrelated to the underlying ability the test is measuring. Flagged items deserve a manual review for cultural, linguistic, or content bias.</p>
</div>
