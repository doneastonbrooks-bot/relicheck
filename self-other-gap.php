...
$current_studio  = $studio_slug; $current_section = 'inferential'; $current_item = 'perception_gaps';
$lens_key = 'self_other_gap';
...
$shell_page_title = 'Self/Other Gap · ' . $_studio['name'];
...
<div class="work-breadcrumb"><span>Inferential Analysis</span><span class="sep">/</span><strong>Self/Other Gap</strong></div>
<div class="work-head"><h2>Self/Other Gap</h2><p>The signature 360 view: per-competency gap between the ratee's self rating and the mean of others' ratings. Positive gaps mean over-rating (blind spots — usually the most useful development focus); negative gaps mean under-rating (hidden strengths). The sample data is designed so Beth over-rates herself and Carl under-rates himself.</p></div>
