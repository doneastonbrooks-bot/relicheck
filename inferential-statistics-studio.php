<?php
// inferential-statistics-studio.php — Inferential Statistics Studio landing page (v4 style, matches studio-mm.php).
...
<section class="sl-features">
  <div class="sl-features-inner">
    <div class="sl-feature-card rv">
      <span class="sl-fc-icon">⚖️</span>
      <h3 class="sl-fc-h">Comparisons</h3>
      <p class="sl-fc-body">t-tests, ANOVA, and chi-square with effect sizes and assumption checks so you know exactly what you can and cannot claim.</p>
    </div>
    <div class="sl-feature-card rv rv-d1">
      <span class="sl-fc-icon">🔗</span>
      <h3 class="sl-fc-h">Relationships</h3>
      <p class="sl-fc-body">Correlations and regression to understand what predicts what and how strongly your variables are connected.</p>
    </div>
    <div class="sl-feature-card rv rv-d2">
      <span class="sl-fc-icon">🛡</span>
      <h3 class="sl-fc-h">Defensible Results</h3>
      <p class="sl-fc-body">Every output tells you what the test can claim and what it can't, so you never overclaim your findings.</p>
    </div>
  </div>
</section>
...
<section class="sl-cta">
  ...
  <div class="rv rv-d1">
    <a href="/analysis-upload-wizard.php?studio=inferential" class="sl-cta-btn">Open Inferential Studio</a>
  </div>
</section>
